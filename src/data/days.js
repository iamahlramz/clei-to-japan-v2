export const DAYS = [
  {
    ...
    transport: {
      ...
      steps: [
        ...
        "Option A (Recommended): Nankai Airport Express to Namba (~45 min, ¥930). At Namba, transfer to Osaka Metro Yotsubashi Line → Hanazono-cho (2 stops south, ~4 min, ¥190). Total: ~55 min, ~¥1,120",
        "Option B (Fastest): Nankai Rapi:t Limited Express to Namba (~34 min, ¥1,450). Same transfer at Namba to Yotsubashi Line. Total: ~45 min, ~¥1,640",
    ...
    items: [
      ...
      { time: "~6:30 PM", text: "Train to Namba → Yotsubashi Line to Hanazono-cho. Check in to Airbnb, drop bags", icon: "🚃", type: "transport" },
      {
        ...
        food: [
          { name: "Takoyaki Doraku Wanaka", desc: "Iconic Dotonbori takoyaki — crispy outside, creamy inside. Get the variety box to try 4 flavors. Walk-up stand, cheap and fast. ~¥600", vibe: "Walk & eat", pick: true },
          { name: "Chibo Dotonbori", desc: "Popular okonomiyaki restaurant — cooked on hotplate in front of you. Kids love watching. Try the signature Dotonboriyaki (¥1,300–1,800). Can get crowded after 5pm, go early or expect a short wait.", vibe: "Sit-down, family-friendly" },
          { name: "Kushikatsu Daruma", desc: "Osaka's most famous kushikatsu chain — deep-fried skewers of meat and vegetables. Fun interactive dining, easy to order. Remember: no double-dipping in the communal sauce! ~¥1,500–2,500/person", vibe: "Fun atmosphere" },
    ...
    tips: [
      "You'll be tired from travel — keep the first evening simple and just enjoy Dotonbori's atmosphere",
      "Hanazono-cho to Namba is just 2 stops on the Yotsubashi Line (~4 min, ¥190)",
      "Hanazono-cho is near Shinsekai — you can walk to Tsutenkaku Tower area in ~10 min",
    ],
  },
  {
    date: "Sat, Mar 28",
    ...
    transport: {
      ...
      steps: [
        ...
        "Consider: Osaka Amazing Pass (1-day ¥2,800/adult) — unlimited subway + free entry to Osaka Castle and 50+ attractions"
      ]
    },
    items: [
      { time: "8:30 AM", text: "Breakfast near Airbnb or grab from konbini", icon: "☕", type: "food",
        food: [
          ...
          { name: "Komeda's Coffee (various locations)", desc: "Popular Japanese coffee chain — famous for generous morning sets. Order a drink and get free thick toast + egg. Kid-friendly, spacious seating", vibe: "Sit-down breakfast", pick: true },
      ...
      { time: "9:30 AM", text: "Osaka Castle Park — explore the grounds amid early cherry blossoms. Wide paths for the stroller, open lawns for the 5yo to run. Castle tower entry: ¥600/adult, free for kids under 15", icon: "🏯", type: "see" },
      { time: "10:30 AM", text: "Nishinomaru Garden (¥200) — best sakura spot with ~300 cherry trees framing the castle. Perfect for photos", icon: "🌸", type: "see" },
      { time: "12:00 PM", text: "Lunch near Osaka Castle / en route to Shinsaibashi", icon: "🍱", type: "food",
        food: [
          { name: "Jo-Terrace Osaka (at castle park entrance)", desc: "Modern food court complex right at the castle. Multiple restaurants — udon, curry, rice bowls. Easy with a group since everyone can pick different food. ~¥800–1,200/person", vibe: "Food court, convenient" },
      ...
      { time: "6:30 PM", text: "Dinner in Dotonbori/Namba area", icon: "🍽️", type: "food",
        food: [
          { name: "CREO-RU Dotonbori", desc: "All Osaka specialties in one place — takoyaki, okonomiyaki, and kushikatsu. 120 seats, great for big groups. ~¥1,500–3,000/person. 5 min from Namba Station", vibe: "All-in-one, family-friendly", pick: true },
          { name: "Kukuru Dotonbori", desc: "30+ year old takoyaki specialty shop — super soft gooey takoyaki with huge octopus chunks. Terrace seats overlooking the canal. Can also order octopus shabu-shabu. ~¥600–1,500", vibe: "Casual, scenic" },
          { name: "Honke Ootako", desc: "Dotonbori's oldest takoyaki shop (since 1972). Extra-large takoyaki with chunky octopus. Spacious eat-in area, serves beer too. Open late. ~¥600–800", vibe: "Classic, late-night" },
          { name: "Gyozaoh! Dotonbori", desc: "Delicious pan-fried gyoza with vegan options available. Counter and table seats. Can get busy on weekends — go at 5pm to avoid wait. ~¥800–1,500", vibe: "Casual, tasty" },
        ]
      },
    ],
    tips: [
      "Osaka Amazing Pass (1-day ¥2,800) pays for itself with free castle entry + unlimited subway",
  ...
  },
  {
    ...
    transport: {
      ...
      steps: [
        ...
        "Kintetsu-Nara Station → Nara Park: Walk east ~5 min. Deer will greet you almost immediately",
    ...
    items: [
      { time: "8:00 AM", text: "Breakfast before heading out", icon: "☕", type: "food",
        food: [
          ...
          { name: "Café at Kintetsu-Nara Station", desc: "Small cafés inside and around the station if you prefer to eat after arriving in Nara", vibe: "On arrival" },
        ]
      },
      ...
      { time: "12:00 PM", text: "Lunch in Nara", icon: "🍡", type: "food",
        food: [
          { name: "Nakatanidou (Higashimuki Street)", desc: "Famous for live mochi pounding — watch the incredible speed! Fresh mochi is ¥150 per piece. The yomogi (mugwort) flavor is the signature. A must-see performance even if you don't eat it", vibe: "Street food, spectacle", pick: true },
          { name: "Kakinoha-zushi shops (Nara specialty)", desc: "Sushi wrapped in persimmon leaves — a Nara original. Tanaka is a popular shop near the park. Light, clean flavors. ~¥800–1,200 for a set", vibe: "Local specialty" },
          { name: "Maguro Koya (near Kintetsu-Nara)", desc: "Affordable and popular tuna rice bowls. Generous portions, quick service. ~¥800–1,000. Kid-friendly with simple rice bowl options", vibe: "Quick, filling" },
      ...
      { time: "6:30 PM", text: "Dinner in Shinsekai (walkable from Airbnb, ~10 min)", icon: "🍢", type: "food",
        food: [
          { name: "Kushikatsu Daruma Shinsekai", desc: "The original kushikatsu restaurant in Osaka — the Shinsekai branch is the flagship. Deep-fried skewers from ~¥100 each. Lively retro atmosphere. No double-dipping!", vibe: "Iconic, must-try", pick: true },
          { name: "Janjan Yokocho Stalls", desc: "The retro alley next to Shinsekai has tiny yakitori, oden, and grilled skewer stalls. Old-school Osaka atmosphere, rock-bottom prices. ~¥500–1,000", vibe: "Walk & eat" },
          { name: "Grill Maruyoshi", desc: "Old-school yoshoku (Japanese Western food) — hambagu (hamburger steak), omurice (omelette rice), and cream croquettes. Comfort food the whole family will love. ~¥800–1,200", vibe: "Retro comfort food, kid-friendly" },
        ]
      },
    ],
    tips: [
      "Bring hand wipes — deer will lick your hands and grab paper items",
      "Nara is very walkable — all major sights within 15 min of Kintetsu station",
      "Shinsekai is right near your Airbnb — great for easy evening outings",
    ],
  },
  {
    date: "Mon, Mar 30",
    ...
    items: [
      { time: "9:00 AM", text: "Breakfast in Umeda after arriving", icon: "☕", type: "food",
        food: [
          { name: "Bills Osaka Station", desc: "Australian brunch restaurant — famous for ricotta pancakes, avocado toast, and scrambled eggs. Kid-friendly menu. ~¥1,200–1,800/person. Opens 8:30am", vibe: "Trendy brunch", pick: true },
          { name: "Hankyu Bakery (B1 Hankyu Dept Store)", desc: "The depachika (basement food hall) at Hankyu opens early. Incredible pastries, sandwiches, and Japanese baked goods. Grab and go. ~¥300–600", vibe: "Quick, high-quality" },
      ...
      { time: "10:00 AM", text: "Grand Front Osaka — Nintendo Store and Pokémon Café (reservation needed!) for the 5yo. Upscale shops throughout", icon: "🎮", type: "shop" },
      ...
      { time: "1:00 PM", text: "Lunch in Umeda area", icon: "🍽️", type: "food",
        food: [
          ...
          { name: "Takimi-Koji (Umeda Sky Building B1)", desc: "Retro food street recreating 1920s Osaka in the Sky Building basement. Multiple restaurants — chicken, Chinese, Japanese course meals. ~¥800–3,000. Save this for later if doing Sky Building at sunset", vibe: "Themed, atmospheric" },
        ]
      },
      ...
      { time: "5:30 PM", text: "Umeda Sky Building — floating garden observatory for sunset over Osaka. Stunning farewell views. Entry: ¥1,500/adult, ¥700 for ages 4-12", icon: "🌅", type: "see" },
      { time: "7:00 PM", text: "Farewell Osaka dinner", icon: "🍽️", type: "food",
        food: [
          { name: "Takimi-Koji (Sky Building B1)", desc: "If you didn't eat here for lunch — the retro food alley is perfect for a final Osaka meal. Multiple small restaurants with different specialties. ~¥1,000–3,000", vibe: "Atmospheric, varied", pick: true },
          { name: "Kani Doraku (various Umeda branches)", desc: "Famous crab restaurant chain — full crab course meals. A splurge-worthy farewell dinner. ~¥4,000–8,000/person for courses. Book ahead if possible", vibe: "Special occasion, splurge" },
          { name: "Yakiniku near Umeda", desc: "Japanese BBQ restaurants are scattered around Umeda. Grill your own wagyu beef at the table — fun, interactive, and kids love the cooking. ~¥2,000–5,000/person", vibe: "Interactive, celebration" },
        ]
      },
    ...
    tips: [
      ...
      "Pokémon Café needs advance reservation — if you didn't book, the Nintendo Store is free to browse",
  ...
  },
  {
    ...
    transport: {
      ...
      steps: [
        ...
        "Option A: Hanazono-cho → Namba (Yotsubashi Line, 4 min) → Nankai Airport Express to Kansai Airport (~45 min). First trains start ~5:30 AM. Total ~55 min",
        ...
        "IMPORTANT: Peach uses Terminal 2 at Kansai Airport — it's separate from Terminal 1. If taking train, you arrive at T1 and need a free shuttle bus to T2 (~10 min). Factor this into your timing!",
        "At New Chitose Airport (Sapporo): JR Rapid Airport train to Sapporo Station (~37 min, ¥1,150). Runs every 15 min"
      ]
    },
    items: [
      ...
      { time: "10:40 AM", text: "Arrive New Chitose Airport → JR Rapid Airport to Sapporo Station (~37 min)", icon: "🛬", type: "transport" },
    ...
    tips: [
      ...
      "ICOCA cards work in Sapporo on JR trains and subways, but you can't reload them at Sapporo subway stations — reload at JR stations, konbini, or 7-Bank ATMs instead",
      "Peach charges ¥1,500–4,500 per checked bag — book baggage online before the flight (cheaper than at the airport). Carry-on limited to 7kg per person",
    ],
  },
  {
    date: "Apr 1–2",
  ...
  },
  {
    ...
    transport: {
      ...
      icon: "🚃",
      steps: [
        "JR Rapid Airport from Sapporo Station → New Chitose Airport (~37 min, ¥1,150)",
    ...
    tips: [
      ...
      "We have a ~5-hour layover at Hong Kong airport (8:35 PM to 1:40 AM). No visa needed for transit. The airport has 24-hour food courts and rest areas. Consider paying for a lounge (~HKD 350/person) for the little one to sleep — Plaza Premium Lounge accepts walk-ins",
    ],
  },
  {
    date: "Sat, Apr 4",
