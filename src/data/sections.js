export const SECTIONS = [
  {
    ...
    content: [
      ...
      { label: "eSIM / Pocket WiFi", text: "Pre-order an eSIM (Ubigi, Airalo, or Mobal) or reserve a pocket WiFi for pickup at Kansai Airport. Coverage needed Mar 27–Apr 3.", links: [{ text: "Airalo eSIM", url: "https://www.airalo.com/japan" }, { text: "Ubigi eSIM", url: "https://www.ubigi.com/en/japan" }] },
